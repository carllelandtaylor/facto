...
2. **Launch the app and screenshot.** Launch the real app the same way as Phase A3. Navigate to each modified UI surface and capture a screenshot. If the app cannot be brought up, record a `manual-described` fallback checklist and report to the caller.
