...
- If it fails (e.g. you're not in a task worktree / on a feature branch), ask the developer for a short kebab-case slug and resolve it with `TASK_DIR="$(factory.sh task-dir "<slug>")"`.
